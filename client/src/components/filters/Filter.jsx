...
import { filterCountriesByContinent, filterActivities,  getAllCountries, getAllActivities, filterByPopulation, getPages, sortBy} from "../../redux/action/index";
import './Filter.css';
...
const Filters = () => {
    ...
    //const filterBySuperficies = e => {
        //dispatch(filterBySuperficie(e.target.value, countries))
    //}
